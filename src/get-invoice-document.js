...
const getInvoiceDocument = (invoice) => {
  return {
    content: [
      ...
      "\n",
      { text: "Contact", style: "h4" },
      invoice.company.contactName ? invoice.company.contactName : undefined,
      invoice.company.contactEmail ? invoice.company.contactEmail : undefined,
      ...
      {
        text: `${invoice.customer.address.zipCode} ${invoice.customer.address.city}`,
        alignment: RIGHT,
      },
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              "Total HT",
              {
                text: printPrice(getNetTotal(invoice.lines)),
                alignment: RIGHT,
              },
            ],
            [
              ...
              "Total TVA",
              {
                text: printPrice(getVATTotal(invoice.lines)),
                alignment: RIGHT,
              },
            ],
            [
    ...
    footer: [
      ...
      {
        text: `${invoice.company.legalForm} au capital de ${invoice.company.founds} €`,
        alignment: "center",
        style: "footer",
      },
    ],
